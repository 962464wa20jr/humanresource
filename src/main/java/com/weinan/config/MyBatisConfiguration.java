...
public class MyBatisConfiguration implements TransactionManagementConfigurer {
    ...
    public SqlSessionFactory sqlSessionFactoryBean() {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.weinan.entity");
        //设置config路径
        ...
        try {
            sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath:com/weinan/dao/mapper/*.xml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
