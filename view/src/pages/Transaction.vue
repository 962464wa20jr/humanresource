  ...
  <div class="mainDiv">
    ...
    <el-row>
      <span class="title-text">
        <i class="fa fa-id-badge"></i>&nbsp;人事事务办理
      </span>
    ...
    <el-row>
      <el-col>
        ...
        <el-form-item>
          <el-input v-model="filtersForm.type" placeholder="事务类型" style="width: 200px;" />
        </el-form-item>
        ...
        <el-form-item>
            <el-select v-model="filtersForm.status" clearable placeholder="审批状态">
                <el-option
    ...
    <el-dialog
      ...
      <el-form :model="addTransactionForm" :rules="rules" ref="addTransactionForm">
        <el-col :span="24">
          <el-form-item label="事务类型" :label-width="formLabelWidth" prop="type">
             <el-select v-model="addTransactionForm.type" clearable placeholder="请选择事务类型">
                <el-option
